...
public class Development_Studies extends JFrame {


    public Development_Studies() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        AIUB_Development_Studies_Course_Label = new JLabel();
        ...
        Masters_in_Development_Studies_Default_Table = new JTable();
        jLabel2 = new JLabel();
        ...
        AIUB_Development_Studies_Course_Label.setFont(new Font("Arial", 1, 24));
        AIUB_Development_Studies_Course_Label.setForeground(new Color(255, 255, 255));
        AIUB_Development_Studies_Course_Label.setText("AIUB Development Studies Course");
        jPanel2.add(AIUB_Development_Studies_Course_Label);
        AIUB_Development_Studies_Course_Label.setBounds(210, 20, 398, 28);
        ...
        Masters_in_Development_Studies_Default_Table.setForeground(new Color(25, 118, 211));
        Masters_in_Development_Studies_Default_Table.setModel(new DefaultTableModel(
            new Object [][] {
                {"1", "DEVELOPMENT ECONOMICS [MDS]", "      3 ",  18000, "Nil"},
                {"1", "GLOBALIZATION AND DEVELOPMENT [MDS", "      3",  18000, "Nil"},
                {"1", "POLITICS, LEADERSHIP AND GOVERNANCE [MDS]", "      3",  18000, "Nil"},
                {"1", "RESEARCH METHODOLOGY [MDS]", "      3",  18000, "None"},
                {"2", "DEVELOPMENT PERSPECTIVE [MDS]", "      3",  18000, "None"},
                {"2", "NGO AND SOCIAL ENTREPRENEURSHIP [MDS]", "      3",  18000, "None"},
                {"2", "STATISTICS FOR DEVELOPMENT [MDS]", "      3",  18000, "15 credits completed"},
                {"2", "MDS ELECTIVE 1", "      3",  18000, "15 credits completed"},
                {"3", "PROJECT PLANNING, MONITORING AND EVALUATION [MDS]", "      3",  18000, "15 credits completed"},
                {"3", "POVERTY STUDIES AND DEVELOPMENT POLICIES [MDS]", "      3",  18000, "18 credits completed"},
                {"3", "SOCIAL ANTHROPOLOGY [MDS]", "      3",  18000, "18 credits completed"},
                {"3", "MDS ELECTIVE 2	", "      3",  18000, "18 credits completed"},
                {"4", "MDS ELECTIVE 3MDS ELECTIVE 3", "      3",  18000, "30 credits completed"},
                {"4", "MDS Thesis (Equivalent Elective 4 )", "      3",  18000, "30 credits completed"},
                {"4", "MDS Thesis (Equivalent Elective 5)", "      3",  18000, "30 credits completed"}
            },
            new String [] {
        ...
        jScrollPane1.setViewportView(Masters_in_Development_Studies_Default_Table);
        if (Masters_in_Development_Studies_Default_Table.getColumnModel().getColumnCount() > 0) {
            Masters_in_Development_Studies_Default_Table.getColumnModel().getColumn(1).setMinWidth(300);
            Masters_in_Development_Studies_Default_Table.getColumnModel().getColumn(1).setPreferredWidth(300);
            Masters_in_Development_Studies_Default_Table.getColumnModel().getColumn(1).setMaxWidth(300);
        }

        jPanel2.add(jScrollPane1);
        jScrollPane1.setBounds(60, 60, 690, 260);
    ...
    private void Add_CourseActionPerformed(ActionEvent evt) {
        ...
        TableModel model1 = Masters_in_Development_Studies_Default_Table.getModel();
       int [] indexs = Masters_in_Development_Studies_Default_Table.getSelectedRows();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Development_Studies.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Development_Studies().setVisible(true);
            }
        });
    }
    ...
    private JLabel AIUB_Development_Studies_Course_Label;
    ...
    private JTable Masters_in_Development_Studies_Default_Table;
