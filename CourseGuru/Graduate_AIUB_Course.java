...
public class Graduate_AIUB_Course extends JFrame {

    public Graduate_AIUB_Course() {
        initComponents();
    }
    ...
    private void ResetActionPerformed(ActionEvent evt) {
            ...
            SelectDepartmentComboBox.removeItem("Department of MBA");
            SelectDepartmentComboBox.removeItem("Department of Public Health");
            SelectDepartmentComboBox.removeItem("Department of Development Studies");
    ...
    private void NextActionPerformed(ActionEvent evt) {
        ...
        {
           MSc_CSE aiub = new MSc_CSE();
           aiub.setVisible(true);
           setVisible(false);
        }

        else if(SelectDepartmentComboBox.getSelectedItem().equals("Department of Engineering")){
           Msc_in_EEE aiub = new Msc_in_EEE();
           aiub.setVisible(true);
           setVisible(false);
        }

        else if(SelectDepartmentComboBox.getSelectedItem().equals("Department of MBA")){
           MBA aiub = new MBA();
           aiub.setVisible(true);
           setVisible(false);
        }

        else if(SelectDepartmentComboBox.getSelectedItem().equals("Department of Public Health")){
           Masters_in_Public_Health aiub = new Masters_in_Public_Health();
           aiub.setVisible(true);
           setVisible(false);
        }
        else if(SelectDepartmentComboBox.getSelectedItem().equals("Department of Development Studies")){
           Development_Studies aiub = new Development_Studies();
           aiub.setVisible(true);
           setVisible(false);
        }
    ...
    private void SelectFacultyComboBoxActionPerformed(ActionEvent evt) {
          ...
          )
        {
            ...
            SelectDepartmentComboBox.addItem("Department of MBA");
        }
        else if
          (
          ...
          )
        {
            ...
            SelectDepartmentComboBox.addItem("Department of Public Health");
            SelectDepartmentComboBox.addItem("Department of Development Studies");
         }
    }
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Graduate_AIUB_Course().setVisible(true);
            }
        });
    }
