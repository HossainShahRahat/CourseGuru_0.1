...
public class BBA extends JFrame {
    ...
    private void initComponents() {
        ...
        Total_Credits_Info.setText("Total Credits: 128");
        ...
        AIUB_BBA_Course_Label.setFont(new Font("Arial", 1, 24));
        AIUB_BBA_Course_Label.setForeground(new Color(255, 255, 255));
        AIUB_BBA_Course_Label.setText("AIUB BBA Course");
        jPanel2.add(AIUB_BBA_Course_Label);
        AIUB_BBA_Course_Label.setBounds(300, 20, 205, 28);
        ...
        BBA_Default_Table.setForeground(new Color(25, 118, 211));
        BBA_Default_Table.setModel(new DefaultTableModel(
            new Object [][] {
                ...
                {"2", "	INTRODUCTION TO ELECTRICAL CIRCUITS LAB", "     1 ", "6000"},
                {"3", "CHEMISTRY", "     3", "18000"},
                ...
                {"3", "DATA STRUCTURE LAB", "     1", "6000"},
                {"3", "COMPUTER AIDED DESIGN & DRAFTING", "     1", "6000"},
                ...
                {"4", "DIGITAL LOGIC AND CIRCUITS LAB", "     1", "6000"},
        ...
        jScrollPane4.setViewportView(BBA_Default_Table);
        if (BBA_Default_Table.getColumnModel().getColumnCount() > 0) {
            BBA_Default_Table.getColumnModel().getColumn(0).setMinWidth(80);
            BBA_Default_Table.getColumnModel().getColumn(0).setPreferredWidth(80);
            BBA_Default_Table.getColumnModel().getColumn(0).setMaxWidth(80);
            BBA_Default_Table.getColumnModel().getColumn(1).setMinWidth(370);
            BBA_Default_Table.getColumnModel().getColumn(1).setPreferredWidth(370);
            BBA_Default_Table.getColumnModel().getColumn(1).setMaxWidth(370);
        }

        jPanel2.add(jScrollPane4);
        jScrollPane4.setBounds(90, 60, 640, 260);
    ...
    private void Add_CourseActionPerformed(ActionEvent evt) {
        ...
        TableModel model1 = BBA_Default_Table.getModel();
       int [] indexs = BBA_Default_Table.getSelectedRows();
    ...
    private JLabel AIUB_BBA_Course_Label;
    private JLabel AIUB_CSE_Course_Label1;
    private JButton Add_Course;
    private JTable BBA_Default_Table;
