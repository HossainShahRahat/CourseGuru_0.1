...
public class Msc_in_EEE extends JFrame {
    ...
    private void initComponents() {
        ...
        MSc_EEE_Default_Table = new JTable();
        ...
        CourseGuruText.setBounds(10, 70, 420, 22);
        ...
        AIUB_EEE_Course_Label.setText("AIUB MSc in EEE Course");
        jPanel2.add(AIUB_EEE_Course_Label);
        AIUB_EEE_Course_Label.setBounds(300, 20, 288, 28);
        ...
        MSc_EEE_Default_Table.setForeground(new Color(25, 118, 211));
        MSc_EEE_Default_Table.setModel(new DefaultTableModel(
            new Object [][] {
                {"1", "ADVANCED TELECOMMUNICATIONS ENGINEERING", "       3",  18000, "Nil"},
                {"1", "MOBILE COMMUNICATION SYSTEMS", "       3",  18000, "Nil"},
                {"1", "FINANCE & INVESTMENT", "       3",  18000, "Nil"},
                {"2", "SELECTED TOPICS IN ELECTRICAL & ELECTRONICS ENGINEERING", "       3",  18000, "None"},
                {"2", "POWER SYSTEM ANALYSIS", "       3",  18000, "None"},
                {"2", "DIGITAL COMMUNICATIONS", "       3",  18000, "None"},
                {"3", "ELECTRICAL DRIVE SYSTEMS", "       3 ",  18000, "15 credits completed"},
                {"3", "COMPUTER CONTROL SYSTEMS", "       3",  18000, "15 credits completed"},
                {"3", "THESIS ", "       3",  18000, "18 credits completed"},
                {"4", "WIRELESS COMMUNICATION TECHNOLOGIES", "       3",  18000, "18 credits completed"},
                {"4", "POWER SYSTEM PLANNING", "       3",  18000, "18 credits completed"},
        ...
        jScrollPane1.setViewportView(MSc_EEE_Default_Table);
        if (MSc_EEE_Default_Table.getColumnModel().getColumnCount() > 0) {
            MSc_EEE_Default_Table.getColumnModel().getColumn(0).setMinWidth(80);
            MSc_EEE_Default_Table.getColumnModel().getColumn(0).setPreferredWidth(80);
            MSc_EEE_Default_Table.getColumnModel().getColumn(0).setMaxWidth(80);
            MSc_EEE_Default_Table.getColumnModel().getColumn(1).setMinWidth(330);
            MSc_EEE_Default_Table.getColumnModel().getColumn(1).setPreferredWidth(330);
            MSc_EEE_Default_Table.getColumnModel().getColumn(1).setMaxWidth(330);
        }
    ...
    private void Add_CourseActionPerformed(ActionEvent evt) {
        ...
        TableModel model1 = MSc_EEE_Default_Table.getModel();
       int [] indexs = MSc_EEE_Default_Table.getSelectedRows();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Msc_in_EEE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Msc_in_EEE().setVisible(true);
            }
        });
    }
    ...
    private JTable MSc_EEE_Default_Table;
