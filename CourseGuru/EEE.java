...
public class EEE extends JFrame {
    ...
    private void initComponents() {
        ...
        Total_Credits_Counts.setBounds(950, 410, 292, 28);
        ...
        Per_Credit_Cost_Info.setBounds(80, 410, 433, 28);
        ...
        AIUB_EEE_Course_Label.setText("AIUB EEE Course");
        jPanel2.add(AIUB_EEE_Course_Label);
        AIUB_EEE_Course_Label.setBounds(300, 20, 202, 28);
        ...
        EEE_Default_Table.setForeground(new Color(25, 118, 211));
        EEE_Default_Table.setModel(new DefaultTableModel(
            new Object [][] {
                {"2", "BASIC MECHANICAL ENGINEERING", "      3", "18000"},
                {"2", "ELECTRICAL CIRCUITS -1 (DC)", "      3", "18000"},
                {"2", "ELECTRICAL CIRCUITS -1 (DC) (LAB)", "      1", "6000"},
                {"2", "Integral Calculus & Ordinary Differential Equation", "      3", "18000"},
                {"2", "PHYSICS 2", "      3", "18000"},
                {"2", "PHYSICS 2 LAB", "      1", "6000"},
                {"2", "PRINCIPLES OF ACCOUNTING", "      3", "18000"},
                {"2", "ENGLISH WRITING SKILLS & COMMUNICATIONS", "      3", "18000"},
                {"3", "COMPLEX VARIABLE,LAPLACE & Z-TRANSFORMATION", "      3", "18000"},
                {"3", "ELECTRICAL CIRCUITS 2 (AC)", "      3 ", "18000"},
                {"3", "ELECTRICAL CIRCUITS-2 (AC) LAB", "      1", "6000"},
                {"3", "ELECTRICAL MACHINES 1", "      3  ", "18000"},
                {"3", "ELECTRICAL MACHINES 1 LAB", "      1", "6000"},
                {"3", "ELECTRONIC DEVICES LAB", "      1", "6000"},
                {"3", "ELECTRONIC DEVICES", "      3", "18000"},
                {"3", "PROGRAMMING LANGUAGE 1 (STRUCTURED PROGRAMMING LANGUAGE)", "      3", "18000"},
                {"3", "BANGLADESH STUDIES", "      3", "18000"},
                {"4", "ELECTRICAL MACHINES 2", "      3", "18000"},
                {"4", "ELECTRICAL MACHINES 2 LAB", "      1", "6000"},
                {"4", "ELECTRICAL POWER TRANSMISSION & DISTRIBUTION", "      3", "18000"},
                {"4", "MATRICES, VECTORS, FOURIER ANALYSIS", "      3", "18000"},
                {"4", "SIGNALS & LINEAR SYSTEMS", "      3", "18000"},
                {"4", "ENGINEERING ETHICS AND ENVIRONMENTAL PROTECTION", "      1", "6000"},
                {"4", "ANALOG ELECTRONICS", "      3", "18000"},
                {"4", "ANALOG ELECTRONICS LAB", "      1", "6000"},
                {"4", "COMPUTER AIDED DESIGN & DRAFTING", "      1", "6000"},
                {"5", "MODERN PHYSICS", "      3", "18000"},
                {"5", "ELECTROMAGNETICS FIELDS AND WAVES", "      3", "18000"},
                {"5", "PRINCIPLES OF ECONOMICS 	", "      2", "12000"},
                {"5", "DIGITAL LOGIC AND CIRCUITS", "      3", "18000"},
                {"5", "DIGITAL LOGIC AND CIRCUITS LAB", "      1", "6000"},
                {"5", "ENGINEERING SHOP", "      1", "6000 "},
                {"5", "INDUSTRIAL ELECTRONICS AND DRIVES", "      3", "18000"},
                {"5", "INDUSTRIAL ELECTRONICS AND DRIVES LAB", "      1", "6000"},
                {"5", "DIGITAL SIGNAL PROCESSING", "      3", "18000"},
                {"6", "ELECTRICAL PROPERTIES OF MATERIALS", "      3", "18000"},
                {"6", "PROGRAMMING LANGUAGE 2 (OBJECT ORIENTED PROGRAMMING LANGUAGE)", "      3  ", "18000"},
                {"6", "POWER SYSTEMS ANALYSIS", "      3", "18000 "},
                {"6", "NUMERICAL METHODS FOR SCIENCE AND ENGINEERING", "      3", "18000"},
                {"6", "COMPUTATIONAL STATISTICS AND PROBABILITY", "      3 ", "18000"},
                {"6", "PRINCIPLES OF COMMUNICATION", "      3", "18000"},
                {"7", "EEE ELECTIVE 1", "      3", "18000"},
                {"7", "BUSINESS COMMUNICATION", "      3", "18000"},
                {"7", "ENGINEERING MANAGEMENT", "      3", "18000"},
                {"7", "MODERN CONTROL SYSTEMS", "      3", "18000"},
                {"7", "MODERN CONTROL SYSTEMS LAB", "      1", "6000"},
                {"7", "MICROPROCESSOR AND EMBEDDED SYSTEM", "      3", "18000"},
                {"7", "CAPSTONE PROJECT 1", "      1 ", "6000"},
                {"8", "EEE ELECTIVE 2", "      3", "18000"},
                {"8", "CAPSTONE PROJECT 2", "      2", "12000"},
                {"8", "INTERNSHIP/ SEMINAR/ WORKSHOP", "      1", "6000"},
                {"8", "ELECTRICAL SERVICES DESIGN LAB", "      1", "6000"},
                {"8", "TELECOMMUNICATIONS ENGINEERING", "      3", "18000"},
                {"8", "POWER STATIONS AND SUBSTATIONS", "      3 ", "18000"},
                {"8", "MEASUREMENT AND INSTRUMENTATION", "      3 ", "18000"},
                {"8", "VLSI CIRCUIT DESIGN", "      3     ", "18000"},
                {null, null, null, null}
            },
            new String [] {
        ...
        jScrollPane1.setViewportView(EEE_Default_Table);
        if (EEE_Default_Table.getColumnModel().getColumnCount() > 0) {
            EEE_Default_Table.getColumnModel().getColumn(0).setMinWidth(80);
            EEE_Default_Table.getColumnModel().getColumn(0).setPreferredWidth(80);
            EEE_Default_Table.getColumnModel().getColumn(0).setMaxWidth(80);
            EEE_Default_Table.getColumnModel().getColumn(1).setMinWidth(370);
            EEE_Default_Table.getColumnModel().getColumn(1).setPreferredWidth(370);
            EEE_Default_Table.getColumnModel().getColumn(1).setMaxWidth(370);
        }

        jPanel2.add(jScrollPane1);
        jScrollPane1.setBounds(70, 62, 645, 260);
    ...
    private void Add_CourseActionPerformed(ActionEvent evt) {
        ...
        TableModel model1 = EEE_Default_Table.getModel();
       int [] indexs = EEE_Default_Table.getSelectedRows();
    ...
    private JTable EEE_Default_Table;
    private JLabel Exit;
    private JLabel Home;
